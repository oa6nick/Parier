...
import { ParierServerInternalModelsBetCommentResponse } from '@/api/client';

interface BetCommentsProps {
    comments: ParierServerInternalModelsBetCommentResponse[];
    currentUser: User;
    ...
    return (
        <div className="flex flex-col h-full">
            <div className="flex-1 overflow-y-auto space-y-4 p-1">
                {comments.length === 0 ? (
                    <div className="text-center text-gray-500 py-8">{t('noComments')}</div>
                ) : (
