        ...
        <div className="bg-white rounded-3xl p-6 shadow-soft border border-gray-100 sticky top-4">
            ...
            {Number(amount) > 0 && (
                <div className="bg-secondary/5 border border-secondary/20 rounded-xl p-4 mb-6 animate-in fade-in slide-in-from-top-2">
                    ...
                    <div className="text-2xl font-bold text-secondary-dark">{format.number(potentialWin)} PAR</div>
                </div>
            )}
            ...
            <div className="mt-4 flex items-start gap-2 text-xs text-gray-400">
                ...
                <p>
                    By placing a bet, you agree to the platform terms. Funds are locked until the event outcome is
                    verified.
                </p>
            </div>
