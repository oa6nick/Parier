      ...
      image={
        <div className="space-y-6">
          <h2 className="text-3xl font-bold leading-tight">
            "Prediction is not just about guessing, it's about <span className="text-primary">understanding</span> the world."
          </h2>
          <div className="flex items-center gap-4">
            ...
            <div className="text-sm font-medium">
              <span className="text-white">{t('predictors')}</span>
              <p className="text-gray-400">joined this week</p>
            </div>
          </div>
        </div>
      }
