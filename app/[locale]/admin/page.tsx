...
export default function AdminPage() {
    ...
    const fetchPreview = useCallback(async () => {
        ...
        try {
            const data = await api.AdminApi.adminCreditPreviewGet(rule).then((response) => response.data);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const data = await api.AdminApi.adminCreditTokensPost({
                amount: numAmount,
                            ...
                            userBalances.map(({ user, balance }) => (
                                ...
                                >
                                    ...
                                    <div className="text-right">
                                        <p className="font-bold text-primary">{format.number(balance.balance)} PAR</p>
                                    </div>
                                </div>
                            ))
                        )}
